...
int main() {
    ...
    JointState input;
    cout << "Input Joint State U1, U2, R1, R2, P1\n";
    cin >> input.U1 >> input.U2 >> input.R1 >> input.R2 >> input.P1;
    double U1 = input.U1;
    double U2 = input.U2;
    double R1 = input.R1;
    double R2 = input.R2;
    ...
    //cout << "Current U2 angle: " << U2 << "\n";
    //cout << "400.0 * sin(U2 + 0.0): " << 400.0 * sin(U2 * PI / 180) << "\n";
    //cout << "Position 1: (" << pos1.x << ", " << pos1.z << ")\n";
